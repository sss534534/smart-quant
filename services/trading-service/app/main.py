...
# 配置日志
logger = setup_logging("trading-service")
...
# 添加中间件
app.add_middleware(RequestMiddleware, service_name="trading-service")
app.add_middleware(PerformanceMiddleware, service_name="trading-service", slow_threshold=1.0)
...
app.include_router(trading.router, prefix=f"{API_V1_PREFIX}/trading", tags=["trading"])
