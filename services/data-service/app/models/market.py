from sqlalchemy import Column, Integer, String, Float, DateTime, Enum, JSON, BigInteger
...
class MarketData(Base):
    ...
    data_type = Column(Enum(MarketDataType), nullable=False, comment='数据类型')
